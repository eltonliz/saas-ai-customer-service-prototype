...
export default function AppHome({ context, goPage }: PageProps) {
  ...
  return (
    <div className="pb-4">
        ...
        <div className="rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 p-4 text-white shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-base font-semibold">{user?.name ?? "用户"}</span>
                <span className="inline-flex items-center gap-1 rounded-full bg-amber-400/20 px-2 py-0.5 text-sm text-amber-200">
                  <Crown size={12} />
                  {user?.level ?? "普通会员"}
                </span>
              </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="rounded-xl bg-white/10 py-2.5 text-center">
              <p className="text-lg font-bold">{user?.coupons ?? 0}</p>
              <p className="text-sm text-blue-200 mt-0.5">优惠券</p>
            </div>
            <div className="rounded-xl bg-white/10 py-2.5 text-center">
              <p className="text-lg font-bold">{user?.points ?? 0}</p>
              <p className="text-sm text-blue-200 mt-0.5">积分</p>
            </div>
            <div className="rounded-xl bg-white/10 py-2.5 text-center">
              <p className="text-lg font-bold">{myConversations.length}</p>
              <p className="text-sm text-blue-200 mt-0.5">历史咨询</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex gap-3 overflow-x-auto px-4 snap-x scrollbar-hide">
          <div className="shrink-0 w-64 rounded-2xl bg-gradient-to-br from-rose-500 to-orange-400 p-4 text-white snap-start">
            <div className="flex items-center gap-2 mb-2">
              <Radio size={20} />
              <span className="text-sm font-semibold">直播专场</span>
            </div>
            <p className="text-sm text-white/80 mb-3">爆款好物限时抢</p>
            <button
              type="button"
              onClick={() => goPage?.("ai-service", { chatPrompt: "直播好物咨询" })}
              className="rounded-full bg-white/20 px-3 py-1.5 text-sm text-white hover:bg-white/30 transition-colors"
            >
              立即查看
            </button>
          </div>
          <div className="shrink-0 w-64 rounded-2xl bg-gradient-to-br from-violet-500 to-purple-500 p-4 text-white snap-start">
            <div className="flex items-center gap-2 mb-2">
              <Sparkles size={20} />
              <span className="text-sm font-semibold">今日权益</span>
            </div>
            <p className="text-sm text-white/80 mb-3">会员专属福利等你领</p>
            <button
              type="button"
          ...
          <div className="shrink-0 w-64 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-500 p-4 text-white snap-start">
            <div className="flex items-center gap-2 mb-2">
              <Stethoscope size={20} />
              <span className="text-sm font-semibold">大健康服务</span>
            </div>
            <p className="text-sm text-white/80 mb-3">AI健康顾问在线答疑</p>
            <button
              type="button"
      ...
      {/* ========== 4. AI客服快捷入口 ========== */}
      <div className="px-4 mb-4">
        <h3 className="text-lg font-semibold text-slate-800 mb-3">AI客服</h3>
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div className="min-w-0">
              <p className="text-sm font-medium text-slate-800">订单问题</p>
              <p className="text-sm text-slate-400 truncate">查物流、改地址</p>
            </div>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <div className="min-w-0">
              <p className="text-sm font-medium text-slate-800">售后问题</p>
              <p className="text-sm text-slate-400 truncate">退换货、退款</p>
            </div>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <div className="min-w-0">
              <p className="text-sm font-medium text-slate-800">商品咨询</p>
              <p className="text-sm text-slate-400 truncate">比价格、问功效</p>
            </div>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <div className="min-w-0">
              <p className="text-sm font-medium text-slate-800">大健康咨询</p>
              <p className="text-sm text-slate-400 truncate">健康科普、产品说明</p>
            </div>
          </button>
        </div>
      </div>
      ...
      {/* ========== 5. 订单提醒 ========== */}
      <div className="px-4 mb-4">
        <h3 className="text-lg font-semibold text-slate-800 mb-3">订单动态</h3>
        <div className="flex flex-col gap-2">
          ...
          >
            ...
            <span className="flex-1 text-sm font-medium text-slate-700">1个订单运输中</span>
          ...
          >
            ...
            <span className="flex-1 text-sm font-medium text-slate-700">售后待确认 1条</span>
            <ChevronRight size={18} className="text-slate-300" />
          </button>
        </div>
      </div>
      ...
      {/* ========== 6. 服务入口 ========== */}
      <div className="px-4 mb-4">
        <h3 className="text-lg font-semibold text-slate-800 mb-3">我的服务</h3>
        <div className="grid grid-cols-4 gap-3">
          ...
          >
            ...
            <span className="text-sm text-slate-600">门店</span>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <span className="text-sm text-slate-600">课程</span>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <span className="text-sm text-slate-600">会员</span>
          </button>
        </div>
      </div>
      ...
      {/* ========== 7. 推荐内容 ========== */}
      <div className="px-4">
        <h3 className="text-lg font-semibold text-slate-800 mb-3">为你推荐</h3>
        <div className="flex flex-col gap-3">
          ...
          <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-slate-800">直播营养套装</p>
                <p className="text-sm text-slate-400">精选营养组合，直播专享价</p>
              </div>
            </div>
            <button
              type="button"
          ...
          <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-slate-800">直播带货实战</p>
                <p className="text-sm text-slate-400">讲师：李老师</p>
              </div>
            </div>
            <button
              type="button"
          ...
          <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-slate-800">星选旗舰店</p>
                <p className="text-sm text-slate-400">西湖区服务中心 | 1.2km</p>
              </div>
            </div>
            <button
              type="button"
