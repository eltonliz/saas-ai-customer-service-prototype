...
export function PhonePreview({ children }: PhonePreviewProps) {
  return (
    <div className="mx-auto flex max-w-lg justify-center">
      <div className="relative w-[375px] overflow-hidden rounded-[44px] border-[6px] border-slate-800 bg-white shadow-2xl">
        <div className="absolute left-1/2 top-0 z-10 h-[28px] w-[140px] -translate-x-1/2 rounded-b-2xl bg-slate-800" />
        <div className="flex min-h-[760px] flex-col bg-white">{children}</div>
