  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-slate-200 bg-white/95 px-5 backdrop-blur">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h1 className="text-base font-semibold text-slate-950">SaaS AI客服系统 高保真原型</h1>
          <p className="text-sm text-slate-500">多租户 · 商家 · 门店 · 渠道 · 业务线 · 权限隔离</p>
        </div>
      </div>
      <div className="flex items-center gap-3">
        ...
        <label className="relative">
          ...
          <select
            ...
            className="appearance-none rounded-lg border border-slate-200 bg-white py-2 pl-3 pr-9 text-sm font-medium text-slate-800 shadow-sm outline-none hover:border-blue-300 focus:border-blue-500"
          >
            {portalOptions.map((p) => (
